...
BB.Block = function(name, options)  {
...
BB.Block.prototype = Object.create(BB.Object.prototype);

BB.Block.prototype.appendField = function(field) {
	this.fields.push(field);
};

BB.Block.prototype.newRow = function() {
	this.fields.push('newRow');
};

BB.Block.prototype.widthType = function(type) {
  if (type == 'grouped') {
...
BB.Block.prototype.renderBlock_ = function() {
