...
var main = function() {
  ...
  taskBlock1 = mainWorkspace.addBlock('taskBlock1', test_blocks.task);
  taskBlock1.render().move(350, 300);
  taskBlock2 = mainWorkspace.addBlock('taskBlock2', test_blocks.task);
  taskBlock2.render().move(350, 350);
